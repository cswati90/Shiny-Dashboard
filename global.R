setwd("C:/my_files/BAPM/Spring Sem/R/Project 1/Team SeeRs project 1/SeeRs Code")
...
co2 = read.csv("C:/my_files/BAPM/Spring Sem/R/Project 1/Team SeeRs project 1/SeeRs Code/co2_emission.csv", stringsAsFactors = F)
